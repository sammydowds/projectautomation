# Generated by Django 2.1.4 on 2019-07-14 20:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Status', models.CharField(choices=[('offtrack', 'Off Track'), ('onwatch', 'On Watch'), ('onhold', 'On Hold'), ('update', 'Update')], default='OT', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Status', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('offtrack', 'Off Track'), ('onwatch', 'On Watch'), ('onhold', 'On Hold'), ('update', 'Update')], default='offtrack', max_length=10, null=True), size=None)),
                ('iscurrent', models.BooleanField(default=True, null=True)),
                ('lastupdated', models.DateField(default=datetime.datetime(2015, 10, 21, 0, 0), null=True)),
                ('projectmanager', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
